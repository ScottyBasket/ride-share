<template>
  <v-container>
    <div>
      ...
      <instructions details="Apply to become a driver for a ride." />
  ...
  data: function () {
    return {
      ...
      rules: {
        ...
        stateAbbreviation: [(val) => val.length == 2 || "Needs to be 2 Letters"],
      },
    };
  },
  methods: {
